...
#define T Table_T
typedef struct T *T; /// non-transparent struct pointer
/// hint: expected table size, in order to enhence performance
/// compare two keys, makes sure the keys are comparable and equatable 
